...
class cur_swap(some_general_structure):
    table_name = 'Example_nine'
    field_list = ['DateBuy', 'DateSell', 'BaseRate', 'SD', 'TIR', 'DeadLineBS']
...
update_query = cur_swap(day_start=1, month_start=12, year_start=2002, day_end=6, month_end=12, year_end=2002,
                        query_string='http://www.cbr.ru/scripts/xml_swap.asp?date_req1=%s/%s/%s&date_req2=%s/%s/%s')
